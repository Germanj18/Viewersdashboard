...
export async function POST(request: NextRequest) {
  try {
    ...
    const requestData = {
      ...
      description,
      timestamp,
      id: `payoneer-${Date.now()}`,
    };

    console.log('Nueva solicitud de pago Payoneer:', requestData);

    // Email para el administrador (tu email)
    const adminEmailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #059669; text-align: center;">💰 Nueva Solicitud de Pago - Payoneer</h2>
        ...
        <div style="background-color: #fef3c7; padding: 15px; border-radius: 8px; margin: 20px 0;">
          ...
          <ol style="color: #92400e; margin: 0; padding-left: 20px;">
            <li>Crear link de pago en Payoneer por $${amount} USD</li>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://wa.me/${whatsapp}?text=Hola%20${encodeURIComponent(customerName)},%20te%20enviamos%20el%20link%20de%20pago%20de%20Payoneer%20por%20$${amount}%20USD" 
          ...
          <a href="mailto:${email}?subject=Link%20de%20Pago%20Payoneer%20-%20ServiceDG&body=Hola%20${encodeURIComponent(customerName)},%0A%0ATe%20enviamos%20el%20link%20de%20pago%20de%20Payoneer%20por%20$${amount}%20USD." 
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #ecfdf5; padding: 15px; border-radius: 8px; margin: 20px 0;">
          ...
          <ol style="color: #065f46; margin: 0; padding-left: 20px;">
            <li>Te enviaremos el link de pago de Payoneer por email</li>
            <li>También te contactaremos por WhatsApp</li>
            <li>Podrás pagar con cualquier tarjeta (incluyendo argentinas)</li>
    ...
    if (process.env.ADMIN_WHATSAPP) {
      try {
        const whatsappMessage = `🚨 NUEVA SOLICITUD PAYONEER 🚨
...
⚡ ACCIONES:
1. Crear link Payoneer por $${amount} USD
2. Enviar a: ${email}
3. WhatsApp: +${whatsapp}`;
    ...
    console.log('🚨 NUEVA SOLICITUD DE PAGO PAYONEER 🚨');
    console.log('================================================');
    ...
    console.log('💬 MENSAJE: Hola ' + customerName + ', te enviamos el link de pago de Payoneer por $' + amount + ' USD');
    console.log('================================================');
    ...
    console.error('Error processing Payoneer request:', error);
    return NextResponse.json(
