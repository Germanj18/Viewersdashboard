  ...
  const exportToJSON = useCallback(() => {
    ...
    const exportData = {
      ...
      summary: {
        ...
        totalViewersSent: getTotalViewersSent(),
        totalResetOperations: metrics.totalResetOperations,
        totalResetViewers: metrics.totalResetViewers,
        costPerViewer: getTotalViewersSent() > 0 ? metrics.totalCost / getTotalViewersSent() : 0
      },
...
<body>
    ...
    <div class="summary-grid">
        ...
        <div class="metric-card">
            <div class="metric-value">${getTotalViewersSent().toLocaleString()}</div>
        ...
        <div class="metric-card">
            <div class="metric-value">\$${getTotalViewersSent() > 0 ? (metrics.totalCost / getTotalViewersSent()).toFixed(4) : '0.0000'}</div>
            ...
            ${Object.entries(metrics.viewersByServiceDuration)
              ...
              .map(([duration, viewers]) => {
                ...
                <tr>
                    ...
                    <td>${totalViewersSent > 0 ? ((viewers / totalViewersSent) * 100).toFixed(1) : 0}%</td>
                </tr>
                `;
              }).join('')}
        </tbody>
    ...
    <div className={`metrics-dashboard ${theme}`}>
      ...
      <div className="metrics-grid">
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            <h3>Total Viewers</h3>
            <div className="metric-value">{(getTotalViewersSent() - getExpiredViewersCount()).toLocaleString()}</div>
            <div className="metric-subtitle">
              Enviados: {getTotalViewersSent().toLocaleString()} | 
